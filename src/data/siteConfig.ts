export const siteConfig = {
  ...
  tagline: "Consultoría Operacional · Argentina",
  description:
    "Consultoría operacional para PyMEs y empresas en Argentina. Ordenamos la ejecución, liberamos el tiempo del dueño y construimos sistemas que funcionan sin burocracia.",
