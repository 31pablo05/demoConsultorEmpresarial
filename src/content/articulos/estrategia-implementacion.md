...
La solución no es un plan mejor. Es un proceso diferente: uno que integra la estrategia al trabajo diario, que involucra a las personas correctas y que tiene mecanismos de ajuste incorporados desde el principio.

En los próximos artículos voy a desarrollar cada uno de estos puntos con casos concretos y herramientas aplicables.
